...
def main(args):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        train_acc = 0
        train_loss = None
        # test_interval = int(len(train_dataloader)/args.testing_session)
        # validation_acc = 0
        ...
        train_acc = (train_acc/num_train_data) * 100
...
if __name__ == '__main__':
    ...
    parser.add_argument('--testing_session', type=int, default=10, help="Number of test session during training")
